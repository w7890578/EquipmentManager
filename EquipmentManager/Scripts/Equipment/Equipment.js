    ...
    $.ajax({
        ...
        success: function (res) {
            $('#fmDetail').form('load', {
                ...
                Name: res.Name,//名称
                Code: res.Code,//编码
                Classify: res.Classify,//分类
                Address: res.Address,//位置
                Description: res.Description,//描述
                CreateTime: res.CreateTime,//创建时间
                CreateBy: res.CreateBy,//创建人
                ModifyBy: res.ModifyBy,//修改人
                ModifyTime: res.ModifyTime,//修改时间
                ImageLink: res.ImageLink//图像链接,
            });
            $("#ImageView").attr("src", res.ImageLink);
            $("#tr_ImageView").show();
            $("#EquipmentImageLink").val("");
            ...
            if (view != undefined) {
                ...
                $("#tr_Image").hide();
                // $('#fmDetail').form('load', { EquipmentImageLink: "" });
            }
            else {
                $("#DivAddToolBar").show();
                title = "修改信息";
